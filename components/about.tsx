          ...
          <div className="grid gap-10 md:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                The Department of Computer Engineering at Madonna University is
                dedicated to providing students with a solid foundation in both
                hardware and software aspects of computing systems.
              </p>
              <p className="text-muted-foreground mb-4">
              ...
              <p className="text-muted-foreground mb-6">
                With state-of-the-art laboratories and experienced faculty
                members, we offer a conducive environment for learning and
                innovation.
              </p>
              <Link href="/about">
